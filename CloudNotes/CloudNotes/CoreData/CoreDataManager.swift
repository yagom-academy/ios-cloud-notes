...
final class CoreDataManager {
            ...
            if let entity = try context.fetch(cloudNoteFetch) as? [CloudNote] {
                ...
                return entity.map { cloudNote in
                    Memo(
                        ...
                        description: cloudNote.body ?? emptyString,
    ...
    func createMemo(with memo: Memo) -> Bool {
        ...
        entity.setValue(memo.title, forKey: "title")
        entity.setValue(memo.description, forKey: "body")
        entity.setValue(memo.lastUpdatedTime, forKey: "lastUpdatedTime")
